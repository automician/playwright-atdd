...
// TODO: consider adding an additional parameter to define when to skip the test
//       as a boolean value or a function that returns a boolean value
//       maybe name it as `on` (or simply `skip`)
