...
test('handles complex branch names', () => {
  assert.strictEqual(commitRefSlug('feature/ABC-123_my-branch'), 'feature-abc-123-my-branch')
})
...
test('handles mixed special characters', () => {
  assert.strictEqual(commitRefSlug('feat/ABC_123.test@branch'), 'feat-abc-123-test-branch')
})
