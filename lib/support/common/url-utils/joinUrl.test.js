...
test('joins base without trailing slash and path without leading slash', () => {
  assert.strictEqual(joinUrl('https://example.com/app', 'login'), 'https://example.com/app/login')
})
...
test('works with root path as base', () => {
  assert.strictEqual(joinUrl('https://example.com', 'login'), 'https://example.com/login')
})
