...
// TODO: should not it be opposite, i.e. built naming around "Walk" logic over "Skip" logic?
//       then it would be `true` to walk normally, `toString` to work recording `String(value)`
//       and `false` to discard (i.e. skip) the property entirely.
//       Then it would be more consistent for `toString` that is kind of "truthy"
//       in context of walking, while with "skip"-like naming it should be "falsey",
//       that is contrary to the naming.
/**
